...
class ApiDatasetInfo:
    ...
    def register(self, args: RegisterArgs = None,
                 ...
                 expected_basepath: str = None) -> RegistrationJobResult:
...
def run_query_missing_files(api_dataset: ApiDatasetInfo, run_async: bool):
    with new_test_dataset(API_DATASET_NUM_PARTS) as test_ds:
        ...
        ds = api_dataset.register(register_args, expected_basepath=s3path).dataset
        api_dataset.query(query, override_dataset=ds, expected_success_value=True)
