...
register_parser.add_argument('timestamp_column', type=str,
...
query_sources_group.add_argument('--string' '-s', type=str, help='Run the following query string', dest='query_string')
...
unreg_parser.add_argument('--force', action='store_true', help='Unregister a dataset even if it\'s currently in use')
